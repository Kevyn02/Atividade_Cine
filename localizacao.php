...
<head>
    ...
    <title>Cine São Carlos: Localização e Contato</title>
    ...
    <div class="container d-flex justify-content-center">
        <div class="row">
            ...
            <main class="container">
                <div class="row">
                    <div class="card my-2 card_header">
                        <div class="card-header bg-secondary">
                            <h1 class="text-white">Localização e Contato</h1>
                        </div>
                        <div class="card-body bg-cinza">
                            ...
                            <p class="text-center">Localizado em frente ao cinema.</p>
                            <p class="text-center color-red">** Estacionamento é exclusivo para nossos clientes durante
                                a
                                exibição do filme.**</p>
                        </div>
                    </div>
