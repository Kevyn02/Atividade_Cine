...
<head>
    ...
    <title>Cine São Carlos: Sessões Extras</title>
                ...
                <div class="row">
                    <div class="card my-2 card_header">
                        <div class="card-header bg-secondary">
                            <h1 class="text-white">Sessões Extras</h1>
                        </div>
                        <div class="card-body container d-flex bg-cinza">
                            <div>
                                <img class="img-fluid"
                            ...
                            <div class="mx-2">
                                ...
                                <p class="text-center"><strong>Segunda, Terça e Quinta - Feira a partir das
                                        16h.</strong></p>
                                <p class="text-center"><strong>Sábado, Domingo e Quarta - feira a partir das
                                        15h.</strong></p>
                            </div>
                        </div>
                    </div>
