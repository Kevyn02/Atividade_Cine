        ...
        <div class="row">
            ...
            <main class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-center text-underline color-red"><strong>Entenda a nova simbologia das classificações indicativas:</strong></p>
                    <table class="table table-bordered table-responsive">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td rowspan="4">Permitido a entrada caso pai ou responsável acompanhe a criança ou jovem
                                    portando,
